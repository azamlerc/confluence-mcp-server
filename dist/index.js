...
server.tool("confluence_get_point", "Fetch and parse a confluence.org point page by latitude and longitude. Returns structured data about the point including country, nearest place, distance, visit count, and any notes. Warning: confluence.org can be slow (10+ seconds), so this tool has a 30s timeout.", {
...
server.tool("confluence_parse_html", "Parse raw HTML from a confluence.org point page. Useful when you've fetched the HTML yourself (e.g. via browser). Returns the same structured data as confluence_get_point.", {
